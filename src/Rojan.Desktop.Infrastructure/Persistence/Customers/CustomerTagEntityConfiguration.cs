...
/// <summary>EF Core mapping for <see cref="CustomerTagEntity"/> - applied by <see cref="RojanDbContext.OnModelCreating"/>.</summary>
internal sealed class CustomerTagEntityConfiguration : IEntityTypeConfiguration<CustomerTagEntity>
{
    public void Configure(EntityTypeBuilder<CustomerTagEntity> builder)
    {
        ...
        builder.Property(entity => entity.Label).IsRequired();
