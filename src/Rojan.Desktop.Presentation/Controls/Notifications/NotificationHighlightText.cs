...
namespace Rojan.Desktop.Presentation.Controls.Notifications;

/// <summary>
/// Phase 27: Notification Search's "highlight matches" - the same
/// attached-property-pair shape as <c>Controls.Help.HighlightText</c>,
/// duplicated rather than shared because it operates on
/// <see cref="Application.Notifications.HighlightSpan"/>, a distinct
/// type from <c>Application.Help.HighlightSpan</c> (each vertical slice
/// owns its own DTOs in this codebase, never shared across modules).
/// </summary>
public static class NotificationHighlightText
{
    public static readonly DependencyProperty TextProperty =
        DependencyProperty.RegisterAttached("Text", typeof(string), typeof(NotificationHighlightText), new PropertyMetadata(null, OnChanged));

    public static readonly DependencyProperty HighlightsProperty =
        DependencyProperty.RegisterAttached("Highlights", typeof(IReadOnlyList<HighlightSpan>), typeof(NotificationHighlightText), new PropertyMetadata(null, OnChanged));
