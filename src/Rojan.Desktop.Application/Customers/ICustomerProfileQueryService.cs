...
/// <summary>Read-only use case Presentation depends on to load one customer's Customer 360 profile (details, notes, tags, timeline, statistics, booking history) as a single unit of work.</summary>
