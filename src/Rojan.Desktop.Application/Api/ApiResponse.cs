...
/// <summary>Phase 25: Secure API Foundation. Uniform result shape for every <see cref="IApiClient"/> call - callers branch on <see cref="IsSuccess"/> rather than catching exceptions for expected failure modes (a non-2xx response), reserving thrown <see cref="ApiException"/>s for connectivity/timeout/cancellation.</summary>
