...
{
    /// <summary>Pass-through of <see cref="Rojan.Desktop.Domain.Bookings.IBookingRepository.SupportsInProgressAndNoShowStatuses"/> - see that member's own doc comment. <c>BookingPageViewModel</c> reads this to disable the Start/No-Show actions rather than let them fail against a backend-connected repository.</summary>
