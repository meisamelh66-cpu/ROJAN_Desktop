...
public interface IBookingQueryService
{
    ...
    /// <summary>Single-booking lookup - backs <c>BookingWorkflowService.CancelBookingAsync</c> and <c>BookingWorkflowService.RescheduleBookingAsync</c>, both of which need a booking's specialist/schedule to release/move the matching calendar slot. Returns null if no booking with that id exists.</summary>
