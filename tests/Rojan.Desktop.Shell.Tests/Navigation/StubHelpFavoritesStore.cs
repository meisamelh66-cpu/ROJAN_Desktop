...
/// <summary>In-memory <see cref="IHelpFavoritesStore"/> test double - avoids touching the real %LocalAppData% JSON file <c>LocalHelpFavoritesStore</c> persists to.</summary>
