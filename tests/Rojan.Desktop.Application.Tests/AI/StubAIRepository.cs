...
/// <summary>
/// A minimal <see cref="DomainAI.IAIRepository"/> for Application-layer
/// tests - defined here rather than reusing
/// <c>Infrastructure.AI.FakeAIRepository</c> because
/// <c>Rojan.Desktop.Application.Tests</c> deliberately does not reference
/// <c>Rojan.Desktop.Infrastructure</c> (same "Application never depends on
/// Infrastructure" reasoning as <c>Reporting.StubReportingRepository</c>).
/// Seeds one system-defined <see cref="DomainAI.PromptTemplate"/> per
/// <see cref="DomainAI.InsightCategory"/> (including General, the fallback
/// category) so <c>PromptTemplateRepository.GetTemplateForCategoryAsync</c>
/// always resolves.
/// </summary>
