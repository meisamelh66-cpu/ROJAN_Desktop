...
internal sealed class StubServiceQueryService(IReadOnlyList<AppServices.ServiceDto> services) : AppServices.IServiceQueryService
{
    ...
    public Task<IReadOnlyList<AppServices.ServiceCategoryOptionDto>> GetCategoriesAsync(CancellationToken cancellationToken = default) =>
        Task.FromResult<IReadOnlyList<AppServices.ServiceCategoryOptionDto>>([]);
}
...
internal sealed class StubSpecialistQueryService(IReadOnlyList<AppSpecialists.SpecialistDto> specialists) : AppSpecialists.ISpecialistQueryService
{
    ...
    public Task<IReadOnlyList<AppSpecialists.SpecialistDto>> SearchSpecialistsAsync(AppSpecialists.SpecialistSearchFilter filter, CancellationToken cancellationToken = default) =>
        Task.FromResult(specialists);
