...
/// <summary>In-memory <see cref="IWorkspaceRepository"/> test double backing the real <c>Application.Workspaces.WorkspaceService</c> in these tests - same "exercise real Application logic over a fake repository" shape <c>Shell.Tests.Navigation.TestSearchServices</c> already establishes for <c>SearchRankingService</c>.</summary>
